...
// semantic_dictionary.go - Auto-generated from semantic_dictionary_v1_2_2.xlsx
// Version: 1.2.2

// SystemPrompt contains the core AI instructions, rules, and constraints
const SystemPrompt = `# AI QUERY ASSISTANT - SYSTEM INSTRUCTIONS v1.2.2
...
// SemanticDictionary contains tables, metrics, dimensions, joins, aliases, date presets, and examples
const SemanticDictionary = `# SEMANTIC DICTIONARY v1.2.2
...
// DDLSchema contains the complete column-level schema for all tables
const DDLSchema = `# DATABASE SCHEMA (DDL) v1.2.2
