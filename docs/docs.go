    ...
    "definitions": {
        ...
        "models.BannerGenerationRequest": {
            ...
            "properties": {
                ...
                "output": {
                    "description": "Output defines the desired image preset and size constraints.",
                    "allOf": [
                        {
        ...
        "models.BannerOutputParams": {
            ...
            "properties": {
                "image_preset": {
                    "description": "ImagePreset is the desired image orientation. One of \"portrait\",\n\"landscape\" or \"square\". Defaults to \"square\" when omitted.",
                    "type": "string",
                    "enum": [
                        "portrait",
                        "landscape",
